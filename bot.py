#!/usr/bin/env python3
# POSCUS PREDICTER - COMPLETE WORKING BOT WITH API TOGGLE
...
def get_admin_keyboard():
    ...
    return ReplyKeyboardMarkup([
        ...
        ["💰 Add Tokens", "📊 Stats"],
        ["🌐 Ping Server", f"🔄 API {api_status}"],
        ["🔑 Reseller Login", "🏠 Main Menu"]
    ], resize_keyboard=True)

def get_reseller_keyboard():
    return ReplyKeyboardMarkup([
        ["➕ Add Device", "🗑️ Delete Device"],
        ["🔍 Check Device", "💰 My Balance"],
        ["🌐 Ping Server", "🚪 Logout"],
        ["🏠 Main Menu"]
    ], resize_keyboard=True)
